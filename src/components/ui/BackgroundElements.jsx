...
const BackgroundElements = ({ 
  ...
  const variants = {
    ...
    agro: [
      { position: 'top-20 left-10', size: 'w-32 h-32', color: 'bg-green-600', delay: '0s' },
      { position: 'bottom-20 right-10', size: 'w-40 h-40', color: 'bg-yellow-600', delay: '1s' },
      { position: 'top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2', size: 'w-60 h-60', color: 'bg-orange-600', delay: '2s' }
    ]
  };
